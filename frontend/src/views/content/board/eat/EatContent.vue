  ...
  export default {
    ...
    methods: {
      ...
      addItem() {
        ...
        if (this.pannalList.length > 6) {
          alert("최대 7개 까지 가능합니다.");
          return;
        }
      ...
      setRoulettePanel() {
        ...
        const txtWrapperEl = document.querySelectorAll(".txt_wrapper");
        ...
        for (let i = 0; i < panelArrSize; i++) {
          // txt 위치 set
          txtWrapperEl[i].style.transform = this.txtWrapperList[
            panelArrSize - 1
          ].transform;
          txtWrapperEl[i].style.position = this.txtWrapperList[
            panelArrSize - 1
          ].position;
          txtWrapperEl[i].style.top = this.txtWrapperList[panelArrSize - 1].top;
          txtWrapperEl[i].style.left = this.txtWrapperList[
            panelArrSize - 1
          ].left;
